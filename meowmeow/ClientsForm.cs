...
namespace meow11
{
    public partial class ClientsForm : Form
    {
        ...
        public string TextBoxLastNameText { get; set; }
        public string TextBoxPhoneNumberText { get; set; }
        ...
        {
            if (string.IsNullOrEmpty(textBoxFirstName.Text) || string.IsNullOrEmpty(textBoxLastName.Text) || string.IsNullOrEmpty(textBoxPhoneNumber.Text))
            {
                MessageBox.Show("Поля имени, фамилии и номера телефона не могут быть пустыми");
                return;
            }
        ...
        public void buttonAddOperation_Click(object v, EventArgs eventArgs)
        {
            ButtonAddOperation_Click(v, eventArgs);
        }

        public void dataGridViewClients_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }
        public DataGridView DataGridViewClients
        {
            get { return dataGridViewClients; }
        }
    }
}
